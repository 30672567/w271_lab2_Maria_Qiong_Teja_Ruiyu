...
#RMSE to compare the performance of two models

Linear_RMSE=sqrt(mean((comps$co2.x - comps$linear_co2)^2))
Linear_RMSE
ARIMA_RMSE=sqrt(mean((comps$co2.x - comps$arima_co2)^2))
ARIMA_RMSE
