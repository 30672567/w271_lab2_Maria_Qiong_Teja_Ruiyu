...
```{r Data pipeline and reading data, message = F, include = F, echo=F}
# Website went down 
...
```{r EDA - dataset manipulation, include = F, echo=F}
...
```{r EDA - plots, warning = F, include = F, echo=F}
# Time plot
...
```{r EDA - plots diff, warning = F, include = F, echo=F}
# Time plot
...
```{r EDA - KPSS original data, include = F, echo=F}
...
```{r EDA - KPSS differencing data, include= F, echo=F}
...
```{r EDA - classical decomposition: original and differenced data, include = F, echo=F}
...
```{r EDA - STL decomposition, include = F, echo=F}
...
```{r EDA - 5 year moving average growth rate, warning = F, include = F, echo=F}
...
```{r, create monthly data, include = F, echo=F}
...
```{r, decomposition, include = F, echo=F}
# Decomposition
...
```{r, seasonal adjustment, include = F, echo=F}
...
```{r, fig.width = 7, fig.height = 4, fig.align = 'center', warning = F, include = F, echo=F}
...
```{r fig.width=10, fig.height=5, fig.align="center", warning=FALSE, include = F, echo=F}
...
```{r Polynomial and Seasonal Dummy Variables Model Residuals, include = F, echo=F}
...
```{r original model residual, include=F, echo=F}
...
```{r fig16, echo=FALSE, out.width = '50%', fig.show = 'hold', fig.pos='H', fig.cap="Comparison between Acutal Data and Linear and ARIMA Model Forecasts"}
