...
```{r, ARIMA Model, include = F, echo = F}
...
model_fit1.plot <- model_fit1 %>% gg_tsresiduals()+ labs(title = "Model Residual")
ggsave("model_fit1.plot.png", plot = model_fit1.plot, width = 7, height = 4)
