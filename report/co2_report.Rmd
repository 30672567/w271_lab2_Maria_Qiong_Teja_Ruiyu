...
forecasting.results1 <- co2_fit.forecast_2100 %>%
  autoplot()+ labs(title = "ARIMA Model Forecast for 2100")
forecasting.results2 <- mod.quad_season.forecast_2100 %>%
  autoplot(fill = "green", show.legend = TRUE)+ labs(title = "Quadratic Model Forecast for 2100")
forecasting.results3 <- mod.linear_season.forecast_2100 %>%
  autoplot(fill = "orange", show.legend = TRUE)+ labs(title = "Linear Model Forecast for 2100")
